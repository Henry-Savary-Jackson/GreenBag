object frmBrowse: TfrmBrowse
    ...
    object grpHeader: TGroupBox
      ...
      object pnlLeftHeader: TPanel
        ...
        DesignSize = (
          428
          191)
        object lblSearchHeading: TLabel
          Left = 88
          Top = 12
          Width = 240
          Height = 18
          Caption = 'Enter your search query here:'
          Color = 11074996
          ParentColor = False
        end
        object lblCat: TLabel
          ...
          Height = 18
          Hint = 
            'Select the categories that results must be in. Selecting none sh' +
            'ows for all categories.'
  ...
  object grpSideBar: TGroupBox
    ...
    object imgProfile: TImage
      ...
      Width = 73
      Height = 70
      Hint = 'Go to your profile screen'
      Center = True
      ParentShowHint = False
      ShowHint = True
      Stretch = True
