...
Constructor CartItem.Create(Owner: TComponent; Parent : TWinControl; ItemID: string;iQuantity: integer) ;
begin;
  //
...
//
  ...
  redItemInfo.Left := 19;
  redItemInfo.Top := 19;
  redItemInfo.Width := 220;
  redItemInfo.Height := 89;
  ...
  redItemInfo.Font.Height := -11;
  redItemInfo.Font.Name := 'Tahoma';
  redItemInfo.Font.Style := []   ;
  redItemInfo.ParentFont := False;
  ...
  grpRemoveItem.Width := 69 ;
  grpRemoveItem.Height := 82;
  ...
  imgRemoveItem.Width := 55;
  imgRemoveItem.Height := 60;
